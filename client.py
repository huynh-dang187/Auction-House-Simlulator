...
class AuctionClientGUI:
    def __init__(self, root):
        ...
        tk.Label(self.frame_login, text="SÀN ĐẤU GIÁ TRIỆU ĐÔ", font=("Arial", 18, "bold"), bg="lightblue", fg="darkblue").pack(pady=40)
        
        frame_input_login = tk.Frame(self.frame_login, bg="lightblue")
        frame_input_login.pack(pady=10)
        
        tk.Label(frame_input_login, text="Mật danh của bạn:", bg="lightblue", font=("Arial", 12)).pack(side=tk.LEFT)
        self.entry_name = tk.Entry(frame_input_login, width=20, font=("Arial", 12))
    ...
    def add_chat_log(self, msg):
        ...
        self.listbox_chat.yview(tk.END)
